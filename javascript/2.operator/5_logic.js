 ...
 * 논리식1(boolean) || 논리식2(boolean) = 결과값(boolean)
 * - && 연산자는 논리식 1,2가 모두 true인 경우에만 true값을 출력
...
console.log( a < b &&  a == b); //true && false
console.log( a == b &&  a < b); //false && true shortcut
console.log( a < b &&  a != b); //true && true

console.log('----- || : OR ------'  );
console.log( a == b ||  a > b);  //false || false
console.log( a < b ||  a == b); //true || false shortcut
console.log( a == b ||  a < b); //false || true
console.log( a < b ||  a != b); //true || true shortcut
