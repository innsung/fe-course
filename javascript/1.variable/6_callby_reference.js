...
console.log(person.name, person2.name); //person과 person2는 같은 주소값을 가리키기 때문에 person.name도 person2.name의 이순신으로 변경된 값을 가짐
console.log(person.age, person2.age); //person과 person2는 같은 주소값을 가리키기 때문에 person.name도 person2.name의 이순신으로 변경된 값을 가짐
console.log(age2);
