...
let number = '1234456556';
let locNumber = parseInt(number).toLocaleString();   //체이닝
console.log('locNumber =', locNumber);

let fnumber = '1234.456556';
let flocNumber = parseFloat(fnumber).toLocaleString();   
let flocNumber2 = parseFloat(fnumber).toFixed();    //소수점 첫째자리 반올림
let flocNumber3 = parseFloat(fnumber).toFixed(2);    //출력되는 소수점 자리수, 소수점 셋째자리 반올림;
