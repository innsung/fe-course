...
console.log(fruits);
console.log('fruits.splice(0, 1) = ', fruits.splice(0, 1, '🍏')); //요소 삭제
console.log(fruits);

//삭제하지 않고 요소 추가
console.log('fruits.splice(0, 0, 교체아이템) = ', fruits.splice(0, 0, '🍌')); //요소 삭제
console.log(fruits);
...
const sfruitObjCopy1 = sfruitObj.slice(0, sfruitObj.lenght);
const sfruitObjCopy2 = Array.from(sfruitObj);
//sfruitObj의 '🍏'를 '🍎'이모지로 변경
sfruitObj[1].emoji = '🍎';
